...
// Source: com.capturetweet/pkg/service (interfaces: UserService,TweetService,SearchService,BrowserService)
...
// UpdateCaptureImage mocks base method.
func (m *MockTweetService) UpdateCaptureImage(arg0, arg1, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateCaptureImage", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateCaptureImage indicates an expected call of UpdateCaptureImage.
func (mr *MockTweetServiceMockRecorder) UpdateCaptureImage(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
